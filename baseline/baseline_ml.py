...
if __name__ == "__main__":
    if len(sys.argv) == 2:
        ...
        for train, test in kfold.split(x, y):
            ...
            prc_val = precision_score(y[test], results, average='weighted')
            rcl_val = recall_score(y[test], results, average='weighted')
            f_b = f1_score(y[test], results,  average='weighted')
